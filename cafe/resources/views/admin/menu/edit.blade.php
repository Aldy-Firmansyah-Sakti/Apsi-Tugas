                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                        ...
                        <form method="POST" action="{{ route('admin.menu.update', $product) }}" enctype="multipart/form-data">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <!-- Foto -->
                                <div>
                                    <label for="foto" class="block text-sm font-medium text-gray-700 mb-2">Foto Menu (Upload File)</label>
                                    <input type="file" 
                                           id="foto" 
                                           name="foto" 
                                           accept="image/*"
                                ...
                                <!-- Foto URL -->
                                <div>
                                    <label for="foto_url" class="block text-sm font-medium text-gray-700 mb-2">Foto Menu (URL)</label>
                                    <input type="url" 
                                           id="foto_url" 
                                           name="foto_url" 
