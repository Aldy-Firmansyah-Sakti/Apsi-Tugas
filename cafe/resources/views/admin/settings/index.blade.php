    ...
    <div class="flex">
        ...
        <div class="w-64 bg-green-800 min-h-screen shadow-lg">
            ...
            <nav class="mt-6">
                ...
                <a href="{{ route('admin.settings.index') }}" class="flex items-center px-6 py-3 text-white bg-green-700 border-r-4 border-green-400">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1">
            ...
            <main class="p-6">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-2">Halaman Pengaturan</h3>
                    <p class="text-gray-500">Fitur pengaturan sistem akan segera hadir</p>
                </div>
            </main>
        </div>
    </div>
